...
logo_image_resized = logo_image.resize((100, 100), Image.LANCZOS)

# Convert the resized image to a PhotoImage object
logo_photo = ImageTk.PhotoImage(logo_image_resized)

# Set the window icon using the original image (or resized if needed)
root.iconphoto(False, ImageTk.PhotoImage(logo_image))

# Display the logo image in the Tkinter window
logo_label = tk.Label(root, image=logo_photo)
logo_label.pack(pady=10)

# Program name label
program_name_label = tk.Label(root, text="Nehemiah Lot Project", font=("Arial", 16))
program_name_label.pack(pady=10)

# Description text below the label
description_text = tk.Label(
    root, 
    text="This Nehemiah Project is a 5 year Lot project for LCC Isabela to have expand, to have our own church lot. "
         "Each lot costs 5000 pesos. Your contribution will help us reach our goal of 5 million pesos.", 
    wraplength=350,  # Allows text to wrap if it exceeds the width
...
# Start the Tkinter event loop
root.mainloop()
>>>>>>> 465a4a3 (add logo and code updates)
